import { pgTable, serial, varchar, foreignKey, integer, text, unique, timestamp } from "drizzle-orm/pg-core"
...
(table) => {
	return {
		usersGoogleIdKey: unique("users_google_id_key").on(table.googleId),
